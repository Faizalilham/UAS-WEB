<?php
    ...
    $statement = mysqli_query($connection,"SELECT * FROM tb_transaksi WHERE del_flage=0");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="col-12 col-md-12 col-sm-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="hapus_produk_admin.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-block" onclick="return confirm('Apakah Anda yakin ?')">Batal</a>
                            </td>      
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
