<?php
  ...
  $statement = mysqli_query($connection,"SELECT * FROM tb_produk WHERE del_flage = 0 and categori='woman'");
  $statement2 = mysqli_query($connection,"SELECT * FROM tb_produk WHERE del_flage = 0 and categori='man'");
                          ...
                          <div class="col-12 col-md-3 col-sm-6 d-none d-sm-block d-md-block">
                            <div class="card text-center shadow">
                              ...
                              <div class="card-body">
                                ...
                                <h5 class="card-title"><b><?= 'Rp. '.$row['harga']; ?></b></h5>
                                <a
            ...
            <div class="col-md-12">
              ...
              >
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <div class="row">
                      <?php $nomor=1; while($nomor <= 4):?>
                      <?php $row2 = mysqli_fetch_array($statement2)?>
                        <?php if($nomor > 2):?>
                          <div class="col-12 col-md-3 col-sm-6 d-none d-sm-block d-md-block">
                            <div class="card text-center shadow">
                              <img
                                src="product_images/<?= $row2['nama_gambar']; ?>"
                                class="card-img-top"
                                alt="..."
                              />
                              <div class="card-body">
                                ...
                                <h5 class="card-title"><b><?= 'Rp. '.$row2['harga']; ?></b></h5>
                                <a
                                  href="Detail.php?id=<?= $row2['id']; ?>"
                                  target="_blank"
                                  class="btn btn-dark text-uppercase"
                                  >Shop now</a
                                >
