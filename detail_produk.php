        ...
        <div class="col-12 col-md-9 col-sm-12 mt-3">
            <div class="card p-4">
               <div class="card-title ">
                    <h5><b>Detail Products</b></h5>
                    <h6 class="text-muted">Last modified on <?php echo $updated_at; ?></h6>
                    <hr>
               </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-3 col-md-10">
                                <input type="text" class="form-control" name="nama_produk" value="<?php echo $nama;?>" disabled>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12 col-sm-3 col-md-2">
                            ...
                            <div class="col-6 col-sm-3 col-md-2">
                                    <?php $_SESSION['image'] = '<img src="product_images/'.$nama_gambar.'" class="img-fluid" width="200px" height="100px" alt="Profile">'; echo $_SESSION['image']; ?>
                                    <label class="btn btn-default btn-file">
                                        Select Image <input type="file" style="display: none;" name="gambar" disabled>
                                    </label>
                            </div>
                        ...
                        <div class="row mt-3">
                                ...
                                <div class="col-12 col-sm-3 col-md-10"> 
                                    <input type="number" class="form-control" name="harga" value="<?php echo $harga; ?>" disabled>
                                </div>
                        </div>
                        <div class="row mt-3">
                                <div class="col-12 col-sm-3 col-md-2">
                                ...
                                <div class="col-12 col-sm-3 col-md-10">
                                    <input type="text" class="form-control" name="ukuran" value="<?php echo $ukuran;?>" disabled>
                                </div>
                        </div>
                         <div class="row mt-3">
                                <div class="col-12 col-sm-3 col-md-2">
                                ...
                                <div class="col-12 col-sm-3 col-md-10">
                                    <input type="text" class="form-control" name="kategori" value="<?php echo $kategori;?>" disabled>
                                </div>
                        </div>
                        <div class="row mt-3">
                                <div class="col-12 col-sm-3 col-md-2">
                                ...
                                <div class="col-12 col-sm-3 col-md-10">
                                    <textarea class="form-control" id ="deskripsi" name ="deskripsi" disabled><?php echo $deskripsi;?>" </textarea>
                                </div>
                            </div>
